...
func (c *Client) processor() error {
	c.log.Debug("processor starting ")
	defer c.log.Debug("processor stopped")
...
func (c *Client) pinger() (err error) {
	c.log.Debug("pinger starting")
	defer c.log.Debug("pinger stopped")
