...
// Source: github.com/countstarlight/homo/sdk/homo-go (interfaces: Context)

// Package homo is a generated GoMock package.
package homo

import (
	context "context"
	mqtt "github.com/countstarlight/homo/protocol/mqtt"
	homo_go "github.com/countstarlight/homo/sdk/homo-go"
	api "github.com/countstarlight/homo/sdk/homo-go/api"
...
func (m *MockContext) Config() *homo_go.ServiceConfig {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Config")
	ret0, _ := ret[0].(*homo_go.ServiceConfig)
	return ret0
}
...
func (m *MockContext) InspectSystem() (*homo_go.Inspect, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "InspectSystem")
	ret0, _ := ret[0].(*homo_go.Inspect)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockContext) LoadConfig(arg0 string, arg1 interface{}) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "LoadConfig", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// LoadConfig indicates an expected call of LoadConfig
func (mr *MockContextMockRecorder) LoadConfig(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "LoadConfig", reflect.TypeOf((*MockContext)(nil).LoadConfig), arg0, arg1)
}
