...
_FUNCTIONMESSAGE = _descriptor.Descriptor(
  ...
  full_name='aiicy.FunctionMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='ID', full_name='aiicy.FunctionMessage.ID', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='QOS', full_name='aiicy.FunctionMessage.QOS', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='Topic', full_name='aiicy.FunctionMessage.Topic', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='Payload', full_name='aiicy.FunctionMessage.Payload', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='Timestamp', full_name='aiicy.FunctionMessage.Timestamp', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='FunctionName', full_name='aiicy.FunctionMessage.FunctionName', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='FunctionInvokeID', full_name='aiicy.FunctionMessage.FunctionInvokeID', index=6,
...
FunctionMessage = _reflection.GeneratedProtocolMessageType('FunctionMessage', (_message.Message,), {
  ...
  # @@protoc_insertion_point(class_scope:aiicy.FunctionMessage)
  })
