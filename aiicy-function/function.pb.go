...
func init() {
	proto.RegisterType((*FunctionMessage)(nil), "main.FunctionMessage")
}
...
var fileDescriptor_8ac74addf543d91a = []byte{
	...
	0x2e, 0xc9, 0xcc, 0xcf, 0xd3, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0xc9, 0x4d, 0xcc, 0xcc,
	...
	0x00, 0x8d, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0xc1, 0x3e, 0xce, 0x98, 0x87, 0x01, 0x00, 0x00,
}
...
func (c *functionClient) Call(ctx context.Context, in *FunctionMessage, opts ...grpc.CallOption) (*FunctionMessage, error) {
	...
	err := c.cc.Invoke(ctx, "/main.Function/Call", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
